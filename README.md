...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=18217996&assignment_repo_type=AssignmentRepo)
...
```bash
git clone <https://github.com/CI679/fundamentos-de-bash-script-PalomaSandoval>
cd bash_scripting
```
...
Este proyecto se encuentra alojado en **GitHub Classroom**. Puedes acceder al repositorio [aquí](<https://github.com/CI679/fundamentos-de-bash-script-PalomaSandoval>).

---

## Autor

<368027 Paloma Ivonne Sandoval Granados>
